                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="m-t-30" action="/admin/gallery/{{$gallery->id}}update" method="post" enctype="multipart/form-data">
                                @method('patch')
                                @csrf

                                <div class="form-group">
                                    <label for="title">عنوان</label>
                                    <input type="text" class="form-control" name="title" value="{{ old('title',$gallery->title) }}" id="title" aria-describedby="title" placeholder="عنوان">
                                    @if($errors->has('title'))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control editor" name="body"  id="body" aria-describedby="body" placeholder="متن">{{ old('body',$gallery->body) }}</textarea>
                                    @if($errors->has('body'))
                                ...
                                <div class="form-group">
                                    ...
                                    @if(file_exists(public_path($slider['src'])) && $slider['src'])
                                        <img src="{{($slider['src'])}}" alt="" width="500" height="200">
                                    @endif
                                </div>

                                <div class="form-group">
                                    <label for="short_description"> توضیحات کوتاه </label>
                                    <textarea type="text" class="form-control"  name="short_description" id="short_description" aria-describedby="short_description" placeholder="توضیحات کوتاه">{{ old('short_description',$gallery->short_description) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control"  name="meta_description" id="meta_description" aria-describedby="meta_description" placeholder="توضیحات متا">{{ old('meta_description',$gallery->meta_description) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="meta_keyword" value="{{ old('meta_keyword',$gallery->meta_keyword) }}" id="meta_keyword" aria-describedby="meta_keyword" placeholder="کلمات کلیدی">
                                ...
                                <div class="form-group row p-t-20">
                                    <div class="col-sm-4">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio1" name="active" value="1" @if($gallery->active == 1) checked @endif class="custom-control-input">
                                            <label class="custom-control-label" for="customRadio1">فعال</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio2" name="active" value="0" @if($gallery->active == 0) checked @endif class="custom-control-input">
