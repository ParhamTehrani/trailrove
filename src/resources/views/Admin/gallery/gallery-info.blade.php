        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">لیست گالری ها </h4>
                            ...
                            <form action="/admin/gallery" class="mb-2">
                                <div class="row ">
                            ...
                            <div class="table-responsive">
                                <div id="file_export_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                        ...
                                        @if(isset($gallery))
                                            @foreach($gallery as $item)
                                                <tr role="row" class=" @if($i%2==0) even @else odd @endif">
                                                    <td class="sorting_1"><a href="{{'/gallery/' . $item['slug'] }}">{{ $item['title'] }}</a></td>
                                                    <td class="sorting_1">
                                                        @if($item->active == 1)
                                                            فعال
                                                        @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @endcan
                                                        @can('gallery_delete')
                                                            <form action="{{url('admin/gallery/'.$item->id.'destroy')}}"
                                    ...
                                    {{ $gallery->appends($_GET)->links('pagination::bootstrap-4') }}
