                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="m-t-30" action="/admin/page" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control editor" name="body"  id="body" aria-describedby="body" placeholder="متن صفحه">{{ old('body') }}</textarea>
                                    @if($errors->has('body'))
