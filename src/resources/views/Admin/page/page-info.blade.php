        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">لیست صفحه ها </h4>
                            ...
                            <form action="/admin/page" class="mb-2">
                                <div class="row ">
                                        ...
                                        @if(isset($pages))
                                            @foreach($pages as $item)
                                                <tr role="row" class=" @if($i%2==0) even @else odd @endif">
                                                    <td class="sorting_1"><a href="{{'/page/' . $item['slug'] }}">{{ $item['title'] }}</a></td>
                                                    <td class="sorting_1">
                                                        @if($item->active == 1)
                                                            فعال
                                                        @else
                                                    ...
                                                    <td>
                                                        @can('page_edit')
                                                            <a href="/admin/page/{{$item['id']}}/edit">
                                                                <i class="mdi mdi-pencil"
                                                                   style="font-size: 20px; color: blue"></i>
                                                            </a>
                                                        @endcan
                                                        @can('page_delete')
                                                            <form action="{{url('admin/page/'.$item->id.'destroy')}}"
