                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display dataTable"
                                        ...
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="file_export" rowspan="1"
                                                ...
                                                style="width: 0px;">عنوان منو
                                            </th>
                                            <th class="sorting_desc" tabindex="0" aria-controls="file_export"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending"
                                                aria-sort="descending" style="width: 0px;"> صفحه منو
                                            </th>
                                            <th class="sorting_desc" tabindex="0" aria-controls="file_export"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending"
                                                aria-sort="descending" style="width: 0px;"> ترتیب منو
                                            </th>
                                            <th class="sorting_desc" tabindex="0" aria-controls="file_export"
                                                rowspan="1" colspan="1"
                                                aria-label="Position: activate to sort column ascending"
                                                aria-sort="descending" style="width: 0px;"> وضعیت منو
                                            </th>
                                            <th>عملیات</th>
                                        </tr>
                                        </thead>
                                                ...
                                                <tr role="row" class=" @if($i%2==0) even @else odd @endif">
                                                    ...
                                                    <td class="sorting_1">
                                                        @if(isset($item->page_id))
                                                            <a href="/page/{{ @$item->page->slug }}">{{ @$item->page->title }}</a>
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td class="sorting_1">{{ $item['sort'] }}</td>
                                                    <td class="sorting_1">
                                                        @if($item->active == 1)
                                                            فعال
                                                        @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @endcan
                                                        @can('menu_delete')
                                                            <form action="{{url('admin/menu/'.$item->id.'destroy')}}"
                                        ...
                                        <tfoot>
                                        <tr>
                                            <th rowspan="1" colspan="1">عنوان منو</th>
                                            <th rowspan="1" colspan="1">صفحه منو</th>
                                            <th rowspan="1" colspan="1">ترتیب منو</th>
                                            <th rowspan="1" colspan="1">وضعیت منو</th>
