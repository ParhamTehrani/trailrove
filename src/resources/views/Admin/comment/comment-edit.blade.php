                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="m-t-30"  action="/admin/comments/{{$comment->id}}update" method="post">
                                @method('patch')
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body row">
                                        <div class="col-12 mb-3">
                                            ...
                                            <footer class="blockquote-footer">
                                                <cite style="font-size: 14px!important;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif" title="Source Title">{{ $comment->comment }}</cite>
                                            </footer>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <p class="mb-0">ایمیل</p>
                                            <footer class="blockquote-footer">
                                                <cite style="font-size: 14px!important;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif" title="Source Title">{{ $comment->email ?? @$comment->user->email }}</cite>
                                            </footer>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <p class="mb-0">موبایل</p>
                                            <footer class="blockquote-footer">
                                                <cite style="font-size: 14px!important;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif" title="Source Title">{{ $comment->mobile ?? @$comment->user->mobile }}</cite>
                                            </footer>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <p class="mb-0">نام</p>
                                            <footer class="blockquote-footer">
                                                <cite style="font-size: 14px!important;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif" title="Source Title">{{$comment->name ?? @$comment->user->name}}</cite>
                                            </footer>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <p class="mb-2">پاسخ</p>
