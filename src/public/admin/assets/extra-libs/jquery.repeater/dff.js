...
function education_fields(data) {
    console.log(data)
    room++;
    ...
    divtest.innerHTML = data + '<button class="btn btn-danger" type="button" onclick="remove_education_fields(' + room + ');"> <i class="fa fa-minus"></i> </button>'
